...
gswf <- Vectorize(function(w, wL=0.227,
...
g <- function(w)1/(1e-5*(w-0.227)^0.9)

curve(g, 0.227, 0.227+1e-12)
curve(f, 0.227, 0.227+1e-12, add=T, col="red")

integrate(g, 0.227, 0.227+1e-5, rel.tol=.Machine$double.eps^0.25)
integrate(f, 0.227, 0.227+1e-5, rel.tol=.Machine$double.eps^0.03)
quadinf(f, 0.227, 1)
